...
import { ComputerService } from '../services/computer.service';  // Import the service
...
export class ComputerComponent implements OnInit {
  ...
  constructor(private computerService: ComputerService) {} // Inject the service
  ...
  ngOnInit() {
    ...
    if (this.isBrowser) {
      ...
      this.computerService.getData().subscribe(
        (data) => {
