  ...
  @Component({
    selector: 'app-mechbar',
    templateUrl: './mechbar.component.html',
    styleUrl: './mechbar.component.css'
  })

  export class MechbarComponent implements OnInit {
    ...
    ngOnInit(): void {
      ...
      this.barservice.getData().subscribe(
        (data) => {
          ...
          if (data) {
            const Count = data.mech || 0;  // Extract 'Comp' from the response data
