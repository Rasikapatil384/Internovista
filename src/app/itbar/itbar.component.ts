...
@Component({
  selector: 'app-itbar',
  templateUrl: './itbar.component.html',
  styleUrl: './itbar.component.css'
})

export class ItbarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.barservice.getData().subscribe(
      (data) => {
        ...
        if (data) {
          const Count = data.it || 0;  // Extract 'Comp' from the response data
