...
import { EntcService } from '../services/entc.service';

@Component({
  selector: 'app-entc',
  templateUrl: './entc.component.html',
  styleUrl: './entc.component.css'
})
export class EntcComponent implements OnInit{
  ...
  constructor(private entcservice: EntcService) {} // Inject the service
  ...
  ngOnInit() {
    ...
    if (this.isBrowser) {
      ...
      this.entcservice.getData().subscribe(
        (data) => {
